        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            val dummyCoaches = listOf(
                Coach(
                    ...
                    reviewsCount = 142,
                    isVerified = true,
                    bio = "Former State Ranji player with 10+ years of batting mentorship. Specializes in advanced footwork and powerful bat swing alignment.",
                    experienceYears = 12,
                    certifications = "BCCI Level 2 Coach Certificate",
                    sessionPrice = 750.00,
                ...
                Coach(
                    ...
                    reviewsCount = 48,
                    isVerified = true,
                    bio = "Professional cricket coach focusing on young talents and kids' safety training. Specializes in stance adjustment & wristy bat control.",
                    experienceYears = 6,
                    certifications = "ICC Coach Education Level 1",
                    sessionPrice = 450.00,
                ...
                Coach(
                    ...
                    reviewsCount = 982,
                    isVerified = true,
                    bio = "Legendary pace mentor. Learn wrist positioning, seam release, outswing tactics, and match preparation from one of the best outswingers.",
                    experienceYears = 25,
                    certifications = "National Cricket Academy Elite Coach",
                    sessionPrice = 1200.00,
                ...
                Coach(
                    ...
                    name = "Rajesh Kumar",
                    imageUrl = "",
                    skills = "Spin Bowling | Captaincy",
                    rating = 4.5f,
                    reviewsCount = 76,
                    isVerified = false,
                    bio = "Passionate finger spin specialist. Focused on flight, dip, and off-spin drift. Great for academy starters.",
                    experienceYears = 8,
                    certifications = "State Cricket Association Certified Class-C",
                    sessionPrice = 400.00,
                ...
                Coach(
                    ...
                    name = "Ananya Sharma",
                    imageUrl = "",
                    skills = "Wicketkeeping | Fielding",
                    rating = 4.7f,
                    reviewsCount = 112,
                    isVerified = true,
                    bio = "State Women's team vice captain. High-intensity agility drills, glovework reflex correction, and game situational awareness.",
                    experienceYears = 7,
                    certifications = "NIS Diploma in Sports Coaching (Cricket)",
                    sessionPrice = 600.00,
